-- ============================================================================
-- GEEKSHOP FIX: REMOVE ZOMBIE TRIGGERS & DUPLICATES
-- ============================================================================
-- ATENCION: EJECUTAR ESTO EN EL PROYECTO "GEEKSHOP"
-- ============================================================================

-- 1. DROP ALL POSSIBLE LEGACY TRIGGERS
-- Dropping blindly to ensure we kill the "blind insert" triggers
...
DROP TRIGGER IF EXISTS tr_delete_income_payment_journal ON public.income_payments;

-- Check for triggers on daily_incomes just in case
DROP TRIGGER IF EXISTS tr_daily_income_journal ON public.daily_incomes;
-- If any other named trigger exists, we can't guess it easily, but these are the main ones.

-- 2. CREATE THE SINGLE CORRECT FUNCTION (v4 Logic - 4% Commission)
